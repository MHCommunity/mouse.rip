      ...
      <div className="mb-10 grid grid-cols-1 gap-6 sm:grid-cols-2">
        ...
        >
          ...
          <span className="text-sm text-gray-600 dark:text-gray-200">
            From beginner tips to advanced strategies, learn all the strategies you need.
          </span>
        </Link>
        <Link
          href="/extensions"
        ...
        >
          ...
          <span className="text-sm text-gray-600 dark:text-gray-200">
            Enhance your experience with powerful extensions just for MouseHunt.
          </span>
        </Link>
        <Link
          href="/tools"
        ...
        >
          ...
          <span className="text-sm text-gray-600 dark:text-gray-200">
            Optimize your hunting strategy, calculate everything, and more.
          </span>
        </Link>
        <Link
          href="/spreadsheets"
        ...
        >
          ...
          <span className="text-sm text-gray-600 dark:text-gray-200">
            All the data you could ever need, organized and ready to use.
          </span>
        </Link>
      </div>
