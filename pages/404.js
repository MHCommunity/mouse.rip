  ...
  return (
    <div className="grid h-screen place-content-center">
      <div className="text-center">
        <strong className="text-9xl font-light tracking-tighter text-gray-200">404</strong>

        <h1 className="text-2xl font-light tracking-tight text-gray-900 sm:text-4xl">Page not found, did a mouse eat it?</h1>

        <Link href="/">
          <a className="mt-6 block text-sky-600 px-5 py-3 text-sm font-medium hover:text-sky-700">
