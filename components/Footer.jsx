  ...
  return (
    <footer class="mx-auto mt-32 w-full max-w-container px-4 sm:px-6 lg:px-8">
      <div class="border-t border-slate-900/5 py-10">
        <p class="mt-5 text-center text-2xl tracking-tight font-extralight text-sky-500">
          <Link href="/">
            mouse.rip
          </Link>
        </p>
        <div class="mt-2 flex items-center justify-center space-x-2 text-sm font-light leading-6 text-sky-600">
